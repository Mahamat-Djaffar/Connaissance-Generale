...
class RecordChiffrePage extends StatefulWidget {
  final String theme;
  final int difficulty;

  const RecordChiffrePage({
    super.key,
    required this.theme,
  ...
  @override
  State<RecordChiffrePage> createState() => _RecordChiffrePageState();
}

class _RecordChiffrePageState extends State<RecordChiffrePage>
