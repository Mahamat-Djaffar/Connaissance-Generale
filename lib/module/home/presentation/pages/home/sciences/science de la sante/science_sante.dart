...
import 'package:puzzle_app/module/home/domain/model/science/science_sante/science_sante_model.dart';
...
class ScienceSantePage extends StatefulWidget {
  ...
  @override
  State<ScienceSantePage> createState() => _ScienceSantePageState();
}

class _ScienceSantePageState extends State<ScienceSantePage>
  ...
  void initState() {
    super.initState();
    questions = ScienceSanteQuestions.getQuestionsByThemeAndDifficulty(
      widget.theme,
      widget.difficulty,
    );

    if (questions.isEmpty) {
      questions = ScienceSanteQuestions.getRandomQuestions(10);
    }
